  ...
  <div class="profile-content">
      ...
      <div class="flex flex-col md:flex-row gap-6">
        <div class="flex flex-col items-center">
          <div class="relative mb-4">
            <div
              v-if="!user.profileImage && !selectedImage"
    ...
    <div class="bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto mt-[10px]">
      ...
      <form action="">
        ...
        <button
          type="submit"
          class="bg-red-600 text-white p-[10px] my-[5px] w-full rounded shadow-lg font-bold hover:bg-red-700 transition duration-400"
        >
          Delete Account
        </button>
      </form>
