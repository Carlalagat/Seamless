        ...
        <div class="flex flex-col md:flex-row gap-6">
          <div class="flex flex-col items-center">
            <div class="relative mb-4">
              <div v-if="!user.profileImage" class="rounded-full w-32 h-32 bg-gray-400 flex items-center justify-center text-white font-bold text-4xl">
                {{ userInitials }}
              </div>
              <img v-else :src="user.profileImage" class="rounded-full w-32 h-32 object-cover border-4 border-purple-200" :alt="user.username" />
