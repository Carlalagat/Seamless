<template>
  ...
  <div class="flex h-screen">
    ...
    <div
      class="px-1 absolute right-[2px] h-screen flex flex-col md:w-[84%] lg:w-[90%] w-4/5 overflow-auto"
    >
        ...
        datasets: [
          {
            label: "Appointments",
            data: [
              50000, 40000, 30000, 60000, 20000, 40000, 60000, 70000, 90000,
              100000, 150000,
            ],
        ...
        datasets: [
          {
            ...
            data: [
              480, 1000, 346, 1500, 1559, 1299, 1200, 1300, 1500, 1100, 700,
              500,
            ],
            backgroundColor: "rgba(153, 102, 255, 0.6)",
            borderColor: "rgba(153, 102, 255, 1)",
        ...
        datasets: [
          {
            ...
            data: [
              1480, 10000, 16006, 15000, 9000, 8100, 7500, 7100, 6500, 5500,
              2500, 1000,
            ],
            backgroundColor: "rgba(153, 102, 255, 0.6)",
            borderColor: "rgba(153, 102, 255, 1)",
