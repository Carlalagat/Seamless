<template>
  <div class="flex flex-col h-screen bg-gray-100">
    ...
    <div class="bg-purple-700 text-white p-4 flex items-center shadow-md">
      <RouterLink
        to="/tailor-dashboard"
        class="flex items-center space-x-2 mx-[7px]"
      >
        <i class="fa fa-arrow-left"></i>
      </RouterLink>
      <div
        class="w-10 h-10 rounded-full bg-purple-600 flex items-center justify-center mr-3"
      >
    ...
    >
      ...
      <div class="flex justify-center">
        <span
          class="bg-white px-3 py-1 rounded-full text-xs text-gray-500 shadow-sm"
        >
          Today
        </span>
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              v-if="message.sender === 'client' && message.read"
              class="ml-1"
            >
    ...
    return {
      ...
      messages: [
        ...
        },
        {
          sender: "tailor",
          content:
            "Hello! Yes, your order #12345 is in progress. We're currently working on the stitching.",
        ...
        },
        {
          sender: "tailor",
          content:
            "We should have it ready by Friday. Would you like to schedule a fitting?",
