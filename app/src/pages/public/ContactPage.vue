<template>
  <div class="container mx-auto px-4 py-8 md:py-16 lg:py-20">
    <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
      ...
      <div class="w-full lg:w-1/3 xl:w-2/5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 md:gap-6">
        <div class="bg-purple-100 p-5 md:p-6 rounded-lg shadow-xl flex items-center space-x-4">
          <i class="fas fa-map-marker-alt text-purple-600 text-2xl md:text-3xl"></i>
          <div>
            <h3 class="text-base md:text-lg font-semibold">Visit Us</h3>
            <p class="text-gray-600 text-sm md:text-base">Nakuru, Kenyatta Avenue<br>Kenya, 20100</p>
          </div>
        </div>
        <div class="bg-purple-100 p-5 md:p-6 rounded-lg shadow-xl flex items-center space-x-4">
          <i class="fas fa-phone text-purple-600 text-2xl md:text-3xl"></i>
          <div>
            <h3 class="text-base md:text-lg font-semibold">Call Us</h3>
            <p class="text-gray-600 text-sm md:text-base">Mon-Fri, 8am to 5pm<br>+254 123 245 678</p>
          </div>
        </div>
        <div class="bg-purple-100 p-5 md:p-6 rounded-lg shadow-xl flex items-center space-x-4">
          <i class="fas fa-envelope text-purple-600 text-2xl md:text-3xl"></i>
          <div>
            <h3 class="text-base md:text-lg font-semibold">Email Us</h3>
            <p class="text-gray-600 text-sm md:text-base break-words">support@seamless.com<br>customercare@seamless.com</p>
          </div>
        </div>
        <div class="bg-purple-100 p-5 md:p-6 rounded-lg shadow-xl flex items-center space-x-4">
          <i class="fas fa-clock text-purple-600 text-2xl md:text-3xl"></i>
          <div>
            <h3 class="text-base md:text-lg font-semibold">Business Hours</h3>
            <p class="text-gray-600 text-sm md:text-base">Monday to Friday<br>24hrs</p>
          </div>
        </div>
      </div>
    </div>
